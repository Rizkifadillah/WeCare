<form action="{{ route('setting.update', $setting->id)}}" method="post" >
    ...
    <x-card>
         ...
         <div class="row">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('phone_hours') is-invalid @enderror" name="phone_hours" 
                        id="phone_hours" value=" {{  old('phone_hours') ?? $setting->phone_hours}}">
                    @error('phone_hours')
                    <span class="invalid-feedback">{{ $message}}</span>
                    @enderror
                </div>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('company_name') is-invalid @enderror" name="company_name" 
                        id="company_name" value=" {{  old('company_name') ?? $setting->company_name}}">
                    @error('company_name')
                    <span class="invalid-feedback">{{ $message}}</span>
                    @enderror
                </div>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('short_description') is-invalid @enderror" name="short_description" 
                        id="short_description" value=" {{  old('short_description') ?? $setting->short_description}}">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="form-group">
                    <label for="about">Tentang Perusahaan / Aplikasi</label>
                    <textarea type="text" class="form-control summernote @error('about') is-invalid @enderror" name="about" 
                        id="about" value="">{{ old('about') ?? $setting->about}}</textarea>
                    @error('about')
                    <span class="invalid-feedback">{{ $message}}</span>
                    @enderror
            ...
            {{-- <div class="col-lg-6">
                 <div class="form-group">
                    ...
                    <textarea type="text" class="form-control @error('address') is-invalid @enderror" name="address" 
                        id="address" value="">{{ old('address') ?? $setting->address}}</textarea>
                    @error('address')
                    <span class="invalid-feedback">{{ $message}}</span>
                    @enderror
        ...
        <div class="row col-lg-12">
            <div class="form-group">
                <label for="address">Alamat</label>
                <textarea type="text" class="form-control @error('address') is-invalid @enderror" name="address"  cols="100"
                    id="address" value="">{{ old('address') ?? $setting->address}}</textarea>
                @error('address')
                <span class="invalid-feedback">{{ $message}}</span>
                @enderror
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('postal_code') is-invalid @enderror" name="postal_code" 
                        id="postal_code" value=" {{  old('postal_code') ?? $setting->postal_code}}">
                    @error('postal_code')
                    <span class="invalid-feedback">{{ $message}}</span>
                    @enderror
                </div>
