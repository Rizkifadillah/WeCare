...
<div class="row">
    ...
    <div class="col-lg-4">
        ...
        <x-card>
            ...
            <p class="font-weight-bold">Terkumpul dari Rp. {{ format_uang(20000000)}}</p>
                ...
                <div class="tab-pane fade show active" id="pills-waktu" role="tabpanel" aria-labelledby="pills-waktu-tab">
                    @for ($i = 0; $i < 5; $i++)
                        <div>
                            ...
                            <p class="font-weight-bold">Rp. {{format_uang(100000)}}</p>
                            <p class="text-muted">{{tanggal_indonesia(date('Y-m-d'))}}</p>
                        </div>
                    @endfor
                </div>
